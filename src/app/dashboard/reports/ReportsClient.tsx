...
export default function ReportsClient() {
  ...
  const reportsList = [
    ...
    { id: "r6", title: "OTA Channel Yield & Commission Expense Ledger", desc: "Performance by Booking.com, MakeMyTrip, Agoda, Expedia, commission costs & net yield", type: "Financial", category: "financial", timing: "MONTH" },
